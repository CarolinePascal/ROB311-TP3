...
class QLearningAgent(ReinforcementAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        new_q_value= current_q_value + self.alpha*correction
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        for feat in feature_vector:
            q_value += feature_vector[feat]*weights[feat]
        return q_value
    ...
    def update(self, state, action, nextState, reward):
        ...
        correction = reward + self.discount*self.computeValueFromQValues(nextState)-current_q_value
        for feat in feature_vector:
            weights[feat] = weights[feat] +self.alpha*correction*feature_vector[feat]
